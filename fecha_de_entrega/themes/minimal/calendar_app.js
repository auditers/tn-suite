...
fetch(url)
  ...
  .then(data => {
	...
	$('.cart-contents').append('<div class="customDateTitle"><p>'+calendar_textocustomDate+'</p></div><div class="customDate"></div><label for="'+calendar_campo+'">Fecha de entrega</label><input type="date" name="custom['+calendar_campo+']" id="'+calendar_campo+'" required="" style="background-color:#FFFFFF"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/flatpickr/4.2.3/flatpickr.css">');
